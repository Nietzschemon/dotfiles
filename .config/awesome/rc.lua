...
--------------------------------------------------------------------------------------------
    ...
    function ()
        awful.spawn(string.format("dmenu_run -fn Monospace-22",
        beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
	end,
    {description = "show dmenu", group = "dmenu"}),
    -- dmenu apps
    awful.key({ modkey }, "u", function () awful.util.spawn( "UnicodeExplorer" ) end,
        {description = "UnicodeExplorer (smileys)" , group = "dmenu" }),

    -- Website
    awful.key({ modkey }, "w", function () awful.util.spawn( "chromium" ) end,
        {description = "Chromium" , group = "web" }),
    awful.key({ modkey, "Shift" }, "w", function () awful.util.spawn( "chromium --incognito" ) end,
        {description = "Chrome private" , group = "web" }),
    awful.key({ modkey, altkey }, "w", function () awful.util.spawn( "brave --incognito" ) end,
        {description = "Brave private" , group = "web" }),
    awful.key({ modkey, altkey, "Control" }, "w", function () awful.util.spawn( "qutebrowser" ) end,
        {description = "qutebrowser" , group = "web" }),
    awful.key({ modkey, "Control" }, "w", function () awful.util.spawn( "firefox --private" ) end,
        {description = "Firefox private" , group = "web" }),

    -- My applications 
    awful.key({ modkey }, "e", function () awful.util.spawn( "emacs" ) end,
        {description = "emacs" , group = "gui apps" }),
    awful.key({ modkey, altkey }, "o", function () awful.util.spawn( "remmina -c rdp://stefan@172.26.150.205" ) end,
        {description = "Remmnia Odin RDP" , group = "gui apps" }),
    ...
    -- Config files
    awful.key({ modkey, "Shift" }, "a", function () awful.util.spawn( terminal.." -e nvim /home/stefan/.config/awesome/rc.lua" ) end,
        {description = "Awesome config file" , group = "Config Files" }),
    awful.key({ modkey, "Shift" }, "v", function () awful.util.spawn( terminal.." -e nvim /home/stefan/.config/nvim/init.lua" ) end,
    ...
    awful.key({ modkey, "Control", "Shift"}, "r", function () awful.spawn.with_shell("reboot") end,
        {description = "reboot computer" , group = "awesome" }),
    awful.key({ modkey, "Control", "Shift"}, "l", function () awful.spawn.with_shell("xscreensaver-command --lock") end,
