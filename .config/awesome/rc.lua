...
--------------------------------------------------------------------------------------------
  ...
  -- bluetooth
    awful.key({ modkey, "Shift"}, "b", function () awful.spawn.with_shell('bluetoothctl connect $(bluetoothctl devices Paired | dmenu | cut -d" " -f2)') end,
        {description = "Connect bluetooth device" , group = "bluetooth" }),
